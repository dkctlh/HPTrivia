            ...
            VStack {
                ...
                ScrollView {
                    ...
                    VStack(alignment: .leading) {
                        ...
                        Text("Each question is worth 5 points, but if you guess wrong answer, you lose 1 point.")
                            .padding([.horizontal, .bottom])
                        
                        Text("If you are struggling with a question, there is an option to reveal a hint or reveal the book that answer the question.But beware! Using these alsp minuses 1 point each. ")
                            .padding([.horizontal, .bottom])
